...
public class SuperHardLevelAdapter extends RecyclerView.Adapter<SuperHardLevelAdapter.ViewHolder> {

    private ArrayList<Integer> cardFront;

    public SuperHardLevelAdapter(ArrayList<Integer> cardFront) {
